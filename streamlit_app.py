...
myImage = Image.open("Logo_mockup.jpg")
st.image(myImage)
st.title('Zajęcia 1. Translator by s19369')
...
st.write('Aplikacja ma za zadanie tłumaczenie słów lub wyrazów z języka angielskiego na niemiecki')
...
if option == "Wydźwięk emocjonalny tekstu (eng)":
    ...
    if text:
        ...
        st.write(answer)
if option == "Translator na z EN na DE":
    text = st.text_area(label="Wpisz tekst")
    if text == "":
